...
/**
 * Radio-buttons to be used for a post-type's custom-field.
 *
 * @package Vierbeuter\WordPress\Feature\CustomField
 */
class Radios extends RadioSelection
{
    ...
    /**
     * Radios constructor. Requires a list of selections to be passed which is an associative array.
     *
